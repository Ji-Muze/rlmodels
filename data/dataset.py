...
class CreateDataset:
    ...
    def save_data_file(self):
        ...
        for sbert_model in self.sbert_models:
            dirction_137 = '/home/rtx/.cache/huggingface/hub/models--sentence-transformers--all-MiniLM-L6-v2/snapshots/44eb4044493a3c34bc6d7faae1a71ec76665ebc6'
            dirction_151 = '/home/rtx/.cache/huggingface/hub/models--sentence-transformers--all-MiniLM-L6-v2/snapshots/e4ce9877abf3edfe10b0d82785e83bdcb973e22e'
            #model = SentenceTransformer(sbert_model)
            model = SentenceTransformer(dirction_137)
...
if __name__ == '__main__':
    ...
    my_parser.add_argument('--data_type', type=str, default='text', help='Type of custom data.')
